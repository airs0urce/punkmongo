...
import DropCollection from '../views/DropCollection.vue'
import RenameCollection from '../views/RenameCollection.vue'
import DropDatabase from '../views/DropDatabase.vue'
...
const routes = [{
    ...
    },
    {
        ...
        path: '/db/:dbName/col/:collName/drop',
